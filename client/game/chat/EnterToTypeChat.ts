 ...
 *
 * Mobile keeps tap-to-type: the soft-keyboard bridge (MobileChatKeyboard) is the
 * plain-chatbox-mode signal, and the engine-owned typing path in
 * widgetKeyboardInput consumes its keys instead of this controller.
 */
export class EnterToTypeChat {
     ...
     * input (chat typing mode, chatbox dialogs, interface search) releases WASD
     * back to typing.
     */
